...
class MapModel:
    ...
    def __init__(self, runtime_ms, total_neuron_count, percent_connected_neurons_per, excitatory_probability):
        self.runtime_ms = runtime_ms
        self.total_neuron_count = total_neuron_count
        self.percent_connected_neurons_per = percent_connected_neurons_per
    ...
    def populate_neuron_connections(self, n):
        ...
        for connection in random.choices(neurons_wo, k=round(len(self.neurons) * self.percent_connected_neurons_per / 100)):
